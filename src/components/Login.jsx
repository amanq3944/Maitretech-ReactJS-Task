            ...
            <div className='flex flex-col justify-center items-center w-full min-h-screen'>
                ...
                <div>
                    <form onSubmit={handleSubmit} className='py-10 px-5 flex flex-col w-86 shadow-2xl border border-gray-300 space-y-3 rounded font-sans'>
                        <h1 className='text-2xl text-gray-900 font-sans text-center font-semibold'>Login</h1>
                        ...
                        <button onClick={submitHandler} className='text-white rounded bg-blue-500 min-h-8 outline-0'>Login</button>
                        <div className='flex justify-center items-center'>
                            <button className='underline text-blue-800 cursor-pointer' onClick={() => navigate('/register')}>
                                if not registered, please registered
                            </button>
                        </div>
                    </form>
                </div>
